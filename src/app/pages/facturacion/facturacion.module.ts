...
@NgModule({
  ...
  declarations: [InsertarComponent, ConsultarComponent, FiltroPipe, FacturacionComponent],
  providers: [ToasterManagerService, FacturacionService, ModalConfirmacionService],
